...
import os
import pandas as pd
csv_path = "/inspire/hdd/project/continuinglearning/suhaoyang-240107100018/suhaoyang-240107100018/storage/Multi_phase_LT_benchmark/meta/meta_info_patient.csv"
tumor_case_list = list(pd.read_csv(csv_path)["ID"])
print(len([item for item in tumor_case_list if 'd' in item]))