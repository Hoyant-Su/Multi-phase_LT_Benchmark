...
from maskvis import draw_mask
from test_unet import pred_one_image, do_tumorseg_one_slice
...
if __name__ == '__main__':
    ...
    liver_seg_model = torch.load('/lits_liver_mitb0/epoch_17_iou_0.922.pth', DEVICE)
    tumor_seg_model = torch.load('/lits_tumor/epoch_35_iou_0.627.pth', DEVICE)
